...
CK_RV
spy_C_Initialize(CK_VOID_PTR pInitArgs)
{
	CK_RV rv;
...
CK_RV
spy_C_Finalize(CK_VOID_PTR pReserved)
{
	CK_RV rv;
...
CK_RV
spy_C_GetInfo(CK_INFO_PTR pInfo)
{
	CK_RV rv;
...
CK_RV
spy_C_GetSlotList(CK_BBOOL tokenPresent, CK_SLOT_ID_PTR pSlotList,
...
CK_RV
spy_C_GetSlotInfo(CK_SLOT_ID slotID, CK_SLOT_INFO_PTR pInfo)
{
	CK_RV rv;
...
CK_RV
spy_C_GetTokenInfo(CK_SLOT_ID slotID,
...
CK_RV
spy_C_GetMechanismList(CK_SLOT_ID  slotID, CK_MECHANISM_TYPE_PTR pMechanismList,
		CK_ULONG_PTR  pulCount)
{
	CK_RV rv;
...
CK_RV
spy_C_GetMechanismInfo(CK_SLOT_ID  slotID, CK_MECHANISM_TYPE type,
...
CK_RV
spy_C_InitToken (CK_SLOT_ID slotID, CK_UTF8CHAR_PTR pPin, CK_ULONG ulPinLen,
...
CK_RV
spy_C_InitPIN(CK_SESSION_HANDLE hSession, CK_UTF8CHAR_PTR pPin, CK_ULONG  ulPinLen)
{
	CK_RV rv;
...
CK_RV
spy_C_SetPIN(CK_SESSION_HANDLE hSession, CK_UTF8CHAR_PTR pOldPin, CK_ULONG  ulOldLen,
...
CK_RV
spy_C_OpenSession(CK_SLOT_ID  slotID, CK_FLAGS  flags, CK_VOID_PTR  pApplication,
...
CK_RV
spy_C_CloseSession(CK_SESSION_HANDLE hSession)
{
	CK_RV rv;
...
CK_RV
spy_C_CloseAllSessions(CK_SLOT_ID slotID)
{
	CK_RV rv;
...
CK_RV
spy_C_GetSessionInfo(CK_SESSION_HANDLE hSession, CK_SESSION_INFO_PTR pInfo)
{
	CK_RV rv;
...
CK_RV
spy_C_GetOperationState(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pOperationState,
...
CK_RV
spy_C_SetOperationState(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pOperationState, CK_ULONG  ulOperationStateLen,
...
CK_RV
spy_C_Login(CK_SESSION_HANDLE hSession, CK_USER_TYPE userType,
...
CK_RV
spy_C_Logout(CK_SESSION_HANDLE hSession)
{
	CK_RV rv;
	enter("C_Logout");
	spy_dump_ulong_in("hSession", hSession);
...
CK_RV
spy_C_CreateObject(CK_SESSION_HANDLE hSession, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG  ulCount,
...
CK_RV
spy_C_CopyObject(CK_SESSION_HANDLE hSession,
...
CK_RV
spy_C_DestroyObject(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hObject)
{
	CK_RV rv;
...
CK_RV
spy_C_GetObjectSize(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hObject, CK_ULONG_PTR pulSize)
{
	CK_RV rv;
...
CK_RV
spy_C_GetAttributeValue(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hObject,
...
CK_RV
spy_C_SetAttributeValue(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hObject,
		CK_ATTRIBUTE_PTR pTemplate, CK_ULONG  ulCount)
{
	CK_RV rv;
...
CK_RV
spy_C_FindObjectsInit(CK_SESSION_HANDLE hSession, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG  ulCount)
{
	CK_RV rv;
...
CK_RV
spy_C_FindObjects(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE_PTR phObject, CK_ULONG  ulMaxObjectCount,
...
CK_RV
spy_C_FindObjectsFinal(CK_SESSION_HANDLE hSession)
{
	CK_RV rv;
...
CK_RV
spy_C_EncryptInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_Encrypt(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG  ulDataLen,
...
CK_RV
spy_C_EncryptUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen,
...
CK_RV
spy_C_EncryptFinal(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pLastEncryptedPart, CK_ULONG_PTR pulLastEncryptedPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DecryptInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_Decrypt(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pEncryptedData, CK_ULONG  ulEncryptedDataLen,
...
CK_RV
spy_C_DecryptUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pEncryptedPart, CK_ULONG  ulEncryptedPartLen,
...
CK_RV
spy_C_DecryptFinal(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pLastPart, CK_ULONG_PTR pulLastPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DigestInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism)
{
	CK_RV rv;
...
CK_RV
spy_C_Digest(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG  ulDataLen,
...
CK_RV
spy_C_DigestUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DigestKey(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_DigestFinal(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pDigest, CK_ULONG_PTR pulDigestLen)
{
	CK_RV rv;
...
CK_RV
spy_C_SignInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_Sign(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG  ulDataLen,
...
CK_RV
spy_C_SignUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_SignFinal(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pSignature, CK_ULONG_PTR pulSignatureLen)
{
	CK_RV rv;
...
CK_RV
spy_C_SignRecoverInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_SignRecover(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG  ulDataLen,
		CK_BYTE_PTR pSignature, CK_ULONG_PTR pulSignatureLen)
{
	CK_RV rv;
...
CK_RV
spy_C_VerifyInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey)
{
	CK_RV rv;
...
CK_RV
spy_C_Verify(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG  ulDataLen,
...
CK_RV
spy_C_VerifyUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_VerifyFinal(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pSignature, CK_ULONG  ulSignatureLen)
{
	CK_RV rv;
...
CK_RV
spy_C_VerifyRecoverInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
...
CK_RV
spy_C_VerifyRecover(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pSignature, CK_ULONG  ulSignatureLen,
		CK_BYTE_PTR pData, CK_ULONG_PTR pulDataLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DigestEncryptUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen,
		CK_BYTE_PTR pEncryptedPart, CK_ULONG_PTR pulEncryptedPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DecryptDigestUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pEncryptedPart,CK_ULONG  ulEncryptedPartLen,
		CK_BYTE_PTR pPart, CK_ULONG_PTR pulPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_SignEncryptUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG  ulPartLen,
		CK_BYTE_PTR pEncryptedPart, CK_ULONG_PTR pulEncryptedPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_DecryptVerifyUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pEncryptedPart, CK_ULONG  ulEncryptedPartLen,
		CK_BYTE_PTR pPart, CK_ULONG_PTR pulPartLen)
{
	CK_RV rv;
...
CK_RV
spy_C_GenerateKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
		CK_ATTRIBUTE_PTR pTemplate, CK_ULONG  ulCount,
...
CK_RV
spy_C_GenerateKeyPair(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
...
CK_RV
spy_C_WrapKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
...
CK_RV
spy_C_UnwrapKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
...
CK_RV
spy_C_DeriveKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hBaseKey,
...
CK_RV
spy_C_SeedRandom(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pSeed, CK_ULONG  ulSeedLen)
{
	CK_RV rv;
...
CK_RV
spy_C_GenerateRandom(CK_SESSION_HANDLE hSession, CK_BYTE_PTR RandomData, CK_ULONG  ulRandomLen)
{
	CK_RV rv;
...
CK_RV
spy_C_GetFunctionStatus(CK_SESSION_HANDLE hSession)
{
	CK_RV rv;
...
CK_RV
spy_C_CancelFunction(CK_SESSION_HANDLE hSession)
{
	CK_RV rv;
...
CK_RV
spy_C_WaitForSlotEvent(CK_FLAGS flags, CK_SLOT_ID_PTR pSlot, CK_VOID_PTR pRserved)
{
	CK_RV rv;
...
init_spy(void)
{
	...
	if (pkcs11_spy) {
		...
		pkcs11_spy->C_Initialize = spy_C_Initialize;
		pkcs11_spy->C_Finalize = spy_C_Finalize;
		pkcs11_spy->C_GetInfo = spy_C_GetInfo;
		pkcs11_spy->C_GetFunctionList = C_GetFunctionList;
		pkcs11_spy->C_GetSlotList = spy_C_GetSlotList;
		pkcs11_spy->C_GetSlotInfo = spy_C_GetSlotInfo;
		pkcs11_spy->C_GetTokenInfo = spy_C_GetTokenInfo;
		pkcs11_spy->C_GetMechanismList = spy_C_GetMechanismList;
		pkcs11_spy->C_GetMechanismInfo = spy_C_GetMechanismInfo;
		pkcs11_spy->C_InitToken = spy_C_InitToken;
		pkcs11_spy->C_InitPIN = spy_C_InitPIN;
		pkcs11_spy->C_SetPIN = spy_C_SetPIN;
		pkcs11_spy->C_OpenSession = spy_C_OpenSession;
		pkcs11_spy->C_CloseSession = spy_C_CloseSession;
		pkcs11_spy->C_CloseAllSessions = spy_C_CloseAllSessions;
		pkcs11_spy->C_GetSessionInfo = spy_C_GetSessionInfo;
		pkcs11_spy->C_GetOperationState = spy_C_GetOperationState;
		pkcs11_spy->C_SetOperationState = spy_C_SetOperationState;
		pkcs11_spy->C_Login = spy_C_Login;
		pkcs11_spy->C_Logout = spy_C_Logout;
		pkcs11_spy->C_CreateObject = spy_C_CreateObject;
		pkcs11_spy->C_CopyObject = spy_C_CopyObject;
		pkcs11_spy->C_DestroyObject = spy_C_DestroyObject;
		pkcs11_spy->C_GetObjectSize = spy_C_GetObjectSize;
		pkcs11_spy->C_GetAttributeValue = spy_C_GetAttributeValue;
		pkcs11_spy->C_SetAttributeValue = spy_C_SetAttributeValue;
		pkcs11_spy->C_FindObjectsInit = spy_C_FindObjectsInit;
		pkcs11_spy->C_FindObjects = spy_C_FindObjects;
		pkcs11_spy->C_FindObjectsFinal = spy_C_FindObjectsFinal;
		pkcs11_spy->C_EncryptInit = spy_C_EncryptInit;
		pkcs11_spy->C_Encrypt = spy_C_Encrypt;
		pkcs11_spy->C_EncryptUpdate = spy_C_EncryptUpdate;
		pkcs11_spy->C_EncryptFinal = spy_C_EncryptFinal;
		pkcs11_spy->C_DecryptInit = spy_C_DecryptInit;
		pkcs11_spy->C_Decrypt = spy_C_Decrypt;
		pkcs11_spy->C_DecryptUpdate = spy_C_DecryptUpdate;
		pkcs11_spy->C_DecryptFinal = spy_C_DecryptFinal;
		pkcs11_spy->C_DigestInit = spy_C_DigestInit;
		pkcs11_spy->C_Digest = spy_C_Digest;
		pkcs11_spy->C_DigestUpdate = spy_C_DigestUpdate;
		pkcs11_spy->C_DigestKey = spy_C_DigestKey;
		pkcs11_spy->C_DigestFinal = spy_C_DigestFinal;
		pkcs11_spy->C_SignInit = spy_C_SignInit;
		pkcs11_spy->C_Sign = spy_C_Sign;
		pkcs11_spy->C_SignUpdate = spy_C_SignUpdate;
		pkcs11_spy->C_SignFinal = spy_C_SignFinal;
		pkcs11_spy->C_SignRecoverInit = spy_C_SignRecoverInit;
		pkcs11_spy->C_SignRecover = spy_C_SignRecover;
		pkcs11_spy->C_VerifyInit = spy_C_VerifyInit;
		pkcs11_spy->C_Verify = spy_C_Verify;
		pkcs11_spy->C_VerifyUpdate = spy_C_VerifyUpdate;
		pkcs11_spy->C_VerifyFinal = spy_C_VerifyFinal;
		pkcs11_spy->C_VerifyRecoverInit = spy_C_VerifyRecoverInit;
		pkcs11_spy->C_VerifyRecover = spy_C_VerifyRecover;
		pkcs11_spy->C_DigestEncryptUpdate = spy_C_DigestEncryptUpdate;
		pkcs11_spy->C_DecryptDigestUpdate = spy_C_DecryptDigestUpdate;
		pkcs11_spy->C_SignEncryptUpdate = spy_C_SignEncryptUpdate;
		pkcs11_spy->C_DecryptVerifyUpdate = spy_C_DecryptVerifyUpdate;
		pkcs11_spy->C_GenerateKey = spy_C_GenerateKey;
		pkcs11_spy->C_GenerateKeyPair = spy_C_GenerateKeyPair;
		pkcs11_spy->C_WrapKey = spy_C_WrapKey;
		pkcs11_spy->C_UnwrapKey = spy_C_UnwrapKey;
		pkcs11_spy->C_DeriveKey = spy_C_DeriveKey;
		pkcs11_spy->C_SeedRandom = spy_C_SeedRandom;
		pkcs11_spy->C_GenerateRandom = spy_C_GenerateRandom;
		pkcs11_spy->C_GetFunctionStatus = spy_C_GetFunctionStatus;
		pkcs11_spy->C_CancelFunction = spy_C_CancelFunction;
		pkcs11_spy->C_WaitForSlotEvent = spy_C_WaitForSlotEvent;
	}
	else {
